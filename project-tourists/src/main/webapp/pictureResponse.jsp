...
<form method="post" action="/pictureResponse">
    <div class="question">
        ...
        <textarea placeholder="ex: What kind of bird do you see in the picture?" name="question" id="question" rows="5" cols="40"></textarea>
    </div>
    <div class="imageURL">
    ...
    <div class="answer">
        ...
        <input name="answer" id="answer" type="text" placeholder="ex: parrot">
    </div>
