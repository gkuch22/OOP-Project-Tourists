...
<jsp:include page="topBar.jsp" />
    ...
    <form class="multipleForm" method="post" action="fillInTheBlank">
        ...
        <textarea required name="question" id="question" rows="5" cols="40"
        ...
        <div class="answers">
            ...
            <textarea required placeholder="ex: Georgia,England" name="answers" id="answers" rows="2" cols="30"></textarea>
        </div>
